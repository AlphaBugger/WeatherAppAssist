...
class WeatherCollectionViewCell: UICollectionViewCell {
    ...
    private func setupViews() {
        // Add and layout the time label
        timeLabel.font = UIFont.systemFont(ofSize: 12) // Adjust font size based on your measurements
        timeLabel.textAlignment = .center
        
        // Add and layout the temperature label
        temperatureLabel.font = UIFont.systemFont(ofSize: 16) // Adjust font size based on your measurements
        temperatureLabel.textAlignment = .center
        
        // Add and layout the rain chance label
        rainChanceLabel.font = UIFont.systemFont(ofSize: 12) // Adjust font size based on your measurements
        rainChanceLabel.textAlignment = .center
        
        // Configure weather image view to use SF Symbols
        ...
        // Define constraints (Replace these with actual measurements)
        NSLayoutConstraint.activate([
            ...
            weatherImageView.widthAnchor.constraint(equalToConstant: 20), // Replace with actual size
            weatherImageView.heightAnchor.constraint(equalToConstant: 20), // Replace with actual size
...
class WeatherView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        layout.itemSize = CGSize(width: 60, height: 100) // Replace with actual measurements
        layout.minimumLineSpacing = 8 // Replace with actual spacing
        layout.sectionInset = UIEdgeInsets(top: 0, left: 12, bottom: 0, right: 12) // Replace with actual insets
    ...
    private func setupCollectionView() {
        ...
        dateLabel.font = UIFont.systemFont(ofSize: 14, weight: .semibold) // Adjust this to match your design
